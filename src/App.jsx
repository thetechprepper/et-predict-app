            ...
            <Flex direction="column" gap="size-200">
              ...
              {searchResult && (
                <View backgroundColor="gray-200" padding="size-100" borderRadius="regular" marginTop="size-200">
                  ...
                  <br />
                  <Text>Bearing: {searchResult.bearing} deg</Text>
                </View>
              )}
              ...
              {latLonMarker && (
                <View backgroundColor="gray-200" padding="size-100" borderRadius="regular" marginTop="size-200">
                  ...
                  <br />
                  <Text>Bearing: {bearing(myPosition, [parseFloat(latInput), parseFloat(lonInput)]).toFixed(1)} deg</Text>
                </View>
              )}
              ...
              {gridMarker && (
                <View backgroundColor="gray-200" padding="size-100" borderRadius="regular" marginTop="size-200">
                  ...
                  <br />
                  <Text>Bearing: {bearing(myPosition, gridMarker).toFixed(1)} deg</Text>
                </View>
              )}
                                        ...
                                        <View
                                          ...
                                          UNSAFE_style={{
                                            background: idx % 2 === 0
                                              ...
                                              : (
                                                  isDark
                                                    ? 'linear-gradient(145deg, #1f2a36, #18202a)'
                              ...
                              <Item key="plan24">
                                {voacapResults?.raw && (
                                  (() => {
                                    ...
                                    const getColor = (pct) => {
                                      if (pct === '' || pct == null) return isDark ? '#1e1e1e' : '#ffffff';
                                      if (pct >= 90) return isDark ? '#2e7d32' : '#4caf50';
                                      if (pct >= 70) return isDark ? '#9e9d24' : '#ffeb3b';
                                      if (pct >= 50) return isDark ? '#ef6c00' : '#ff9800';
                                      return isDark ? '#c62828' : '#f44336';
                                    };

                                    const tableBorder = isDark ? '#5c5c5c' : '#ccc';
                                    const headerBg = isDark ? '#2a2a2a' : '#f0f0f0';
                                    const cellBg = isDark ? '#1e1e1e' : '#ffffff';
                                    const textColor = isDark ? '#f5f5f5' : '#000000';
                                    const currentHourBg = isDark ? '#1565c0' : '#2196f3';
                                    const currentHourText = '#ffffff';
                                    ...
                                    return (
                                      <div style={{ overflowX: 'auto', marginTop: 10 }}>
                                        ...
                                        >
                                          <thead>
                                            <tr>
                                              <th style={{ border: `1px solid ${tableBorder}`, padding: '4px', background: headerBg }}>Time (UTC)</th>
                                              {allBands.map(b => (
                                                <th key={b} style={{ border: `1px solid ${tableBorder}`, padding: '4px', background: headerBg }}>{b}</th>
                                              ))}
                                            </tr>
                                          </thead>
                                          <tbody>
                                                ...
                                                <React.Fragment key={idx}>
                                                  {showRepeatHeader && (
                                                    <tr>
                                                      <th style={{ border: `1px solid ${tableBorder}`, padding: '4px', background: headerBg }}>Time (UTC)</th>
                                                      {allBands.map(b => (
                                                        <th key={`repeat-${idx}-${b}`} style={{ border: `1px solid ${tableBorder}`, padding: '4px', background: headerBg }}>{b}</th>
                                                      ))}
                                                    </tr>
                                                  )}
                                                  ...
                                                  <tr>
                                                    <td
                                                      style={{
                                                        ...
                                                        padding: '4px',
                                                        backgroundColor: isCurrentHour ? currentHourBg : cellBg,
                                                        color: isCurrentHour ? currentHourText : textColor,
